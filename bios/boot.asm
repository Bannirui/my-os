...
; 临时变量 
StartBootMessage:  db "Hello MY-OS"                        ;                启动界面提示信息
...
Label_Start:
    ...
    xor cx, cx                                             ;                CH=0x00 CL=0x00 左上角坐标=[0,0]
    ...
    mov cx, 11                                             ;                要显示的字符串长度
    mov bx, 0x007a                                         ;                BH=0x00 BL=0 111 1 010
    xor dx, dx                                             ;                DH=0x00 DL=0x00
