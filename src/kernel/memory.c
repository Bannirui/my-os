...
void init_memory() {
    ...
    for (int i = 0; i <= memory_management_struct.e820_length; i++) {
        ...
        unsigned long end = ((memory_management_struct.e820[i].address + memory_management_struct.e820[i].length) >>
    ...
    memory_management_struct.bits_map = (unsigned long *) (
        (memory_management_struct.end_brk + PAGE_4K_SIZE - 1) & PAGE_4K_MASK);
    memory_management_struct.bits_size = TotalMem >> PAGE_2M_SHIFT;
    memory_management_struct.bits_length = (((unsigned long) (TotalMem >> PAGE_2M_SHIFT) + sizeof(long) * 8 - 1) / 8) &
                                           (~(sizeof(long) - 1));
    ...
    memory_management_struct.pages_struct = (struct Page *) (
        ((unsigned long) memory_management_struct.bits_map + memory_management_struct.bits_length + PAGE_4K_SIZE - 1) &
        PAGE_4K_MASK);
    ...
    memory_management_struct.zones_struct = (struct Zone *) (
        ((unsigned long) memory_management_struct.pages_struct + memory_management_struct.pages_length + PAGE_4K_SIZE -
         1) & PAGE_4K_MASK);
    ...
    for (int i = 0; i <= memory_management_struct.e820_length; i++) {
        ...
        //zone init
        struct Zone *z = memory_management_struct.zones_struct + memory_management_struct.zones_size;
    ...
    unsigned long i = Virt_To_Phy(memory_management_struct.end_of_struct) >> PAGE_2M_SHIFT;
